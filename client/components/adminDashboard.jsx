  ...
  return (
    <div id="admin_dashboard">
      ...
      <h4>Active Students: {onlineUsers.student}
        <span className='admin_dashboard_span'>Current Open Tickets: {adminStats.open}</span>
      </h4>
      <h4>Active Mentors: {onlineUsers.mentor}
        <span className='admin_dashboard_span'>Tickets Closed Today: {adminStats.closed}</span>
      </h4>
      {/* <h4>Current Average Wait Time: {onlineUsers.currAveWait} minutes
        <span className='admin_dashboard_span'>Most Popular Category Today: {adminStats.popularCategory}</span>
      </h4> */}
      <AddUser />
