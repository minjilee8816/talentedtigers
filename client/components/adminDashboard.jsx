...
const AdminDashboard = ({filterTickets, statistic, ticketCategoryList}) => (
  <div id="admin_dashboard">
    ...
    <h4>Active Students: {statistic.studentNum}
      <span className='admin_dashboard_span'>Current Open Tickets: {statistic.open}</span>
    </h4>
    <h4>Active Mentors: {statistic.mentorNum}
      <span className='admin_dashboard_span'>Tickets Closed Today: {statistic.closed}</span>
    </h4>
    <h4>Current Average Wait Time: {statistic.currAveWait} minutes
      <span className='admin_dashboard_span'>Most Popular Category Today: {statistic.popularCategory}</span>
    </h4>
    <AddUser />
