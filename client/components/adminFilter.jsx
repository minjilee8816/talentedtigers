...
const AdminFilter = ({getMentors, filterTickets, showMentors, ticketCategoryList}) => (
  <form>
    <div className="form-group row">
      ...
      <div className="col-xs-3">
        ...
        <button onClick={getMentors} id="mentor-button" className="btn btn-primary">Show Mentors</button>
      </div>
    </div>
  </form>
);
